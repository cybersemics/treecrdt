# @justtemporary/wa-sqlite (scaffold)
...
```
pnpm --filter @justtemporary/wa-sqlite-vendor build
...
import { createWaSqliteApi } from "@justtemporary/wa-sqlite";
...
## Playwright
`pnpm --filter @justtemporary/wa-sqlite test:e2e` runs Vite dev + Playwright and asserts the demo can append/fetch ops via the extension.
