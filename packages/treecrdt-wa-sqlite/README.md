# @justthrowaway/wa-sqlite (scaffold)
...
```
pnpm --filter @justthrowaway/wa-sqlite-vendor build
...
import { createWaSqliteApi } from "@justthrowaway/wa-sqlite";
...
## Playwright
`pnpm --filter @justthrowaway/wa-sqlite test:e2e` runs Vite dev + Playwright and asserts the demo can append/fetch ops via the extension.
