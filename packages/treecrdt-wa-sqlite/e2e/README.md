...
This package hosts the React demo and Playwright e2e tests for the TreeCRDT wa-sqlite build. The library code lives in `@justtemporary/wa-sqlite`; this package depends on it and exercises it in the browser.
